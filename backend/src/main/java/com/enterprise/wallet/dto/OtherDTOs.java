...
/**
 * Other Data Transfer Objects (Payment Links, Notifications, Reports, etc.)
 */
public class OtherDTOs {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class WalletStatementResponse {
        ...
        private List<TransactionDTOs.TransactionResponse> transactions;
    }

    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    public static class SpendingAnalyticsResponse {
        private Long walletId;
        private String period;
